...
from update_tags_artist_tracktitle import get_deezer_track_info_audio, display_info, update_mp3_tags_audio, add_cover_art_audio, rename_file_audio, subtract_string
    ...
    for title in titles:
        ...
        if not os.path.exists(file_path):
            ...
            while not os.path.exists(file_path):
                file_path = input("Por favor, informe o título correto com a extensão .mp3: ")
